clc
clear all
load("simulation_glgd2_data1_n1000_r1000.mat")
...
for re=1:repeat
    ...
    [parameters5, stderrors5, LLF5, mux5, hx5, sx5, kx5, pvalues5,AIC5,BIC5] = ACD_logconstant_nnsnp2(randxx',xx,1,[]) ;

    params5(re,:)=parameters5';
    sd5(re,:)=stderrors5';
end
save("simulation_glgd2_logacd1_data1_n1000_r1000.mat")